...
def admin_qr_messages():
    ...
    return jsonify({route: {'label': ROUTE_LABELS.get(route, route), 'message': current_message(route), 'url': request.host_url.rstrip('/') + '/event/' + route} for route in ROUTES})
